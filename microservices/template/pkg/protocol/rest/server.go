...
import (
    ...
    "github.com/laetadevelopment/microservice/microservices/template/pkg/protocol/rest/middleware"
)
...
func RunServer(ctx context.Context, grpcPort, httpPort string) error {
    ...
    if err := v1.RegisterTemplateServiceHandlerFromEndpoint(ctx, mux, "localhost:"+grpcPort, opts); err != nil {
