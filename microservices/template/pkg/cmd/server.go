...
import (
	...
	"github.com/laetadevelopment/microservice/microservices/template/pkg/protocol/grpc"
	"github.com/laetadevelopment/microservice/microservices/template/pkg/protocol/rest"
	"github.com/laetadevelopment/microservice/microservices/template/pkg/service/v1"
)
...
func RunServer() error {
	...
	v1API := v1.NewTemplateServiceServer(db)
